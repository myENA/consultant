...
//	}
//
//	return NewManagedServiceBuilder(c, sid, reg.Name, reg.Tags)
//}
//
...
//}
//
//func NewManagedServiceBuilder(client *Client, serviceID, serviceName string, registeredTags []string) (*ManagedService, error) {
